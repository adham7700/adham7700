...
<h1 align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=1565C0&center=true&vCenter=true&width=600&lines=Hi+%F0%9F%91%8B%2C+I'm+Adham+Mohamed;Full+Stack+Developer;.NET+%7C+React+%7C+Node.js;Building+Scalable+Solutions" alt="Typing SVG" />
  </a>
</h1>
-->
<p align="center">
...
│  🏆 Published Researcher in AI/ML (ArSLR – NILES 2024)                      │
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/ASP.NET%20Core-1a237e?style=for-the-badge&logo=dotnet&logoColor=white" />
  <img src="https://img.shields.io/badge/Node.js-0d47a1?style=for-the-badge&logo=node.js&logoColor=white" />
  <img src="https://img.shields.io/badge/Express.js-1565C0?style=for-the-badge&logo=express&logoColor=white" />
  <img src="https://img.shields.io/badge/Entity%20Framework%20Core-1a237e?style=for-the-badge&logo=dotnet&logoColor=white" />
  <img src="https://img.shields.io/badge/SQL%20Server-0d47a1?style=for-the-badge&logo=microsoft-sql-server&logoColor=white" />
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/TypeScript-1a237e?style=for-the-badge&logo=typescript&logoColor=white" />
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/GitHub%20Actions-1a237e?style=for-the-badge&logo=github-actions&logoColor=white" />
  <img src="https://img.shields.io/badge/Git-0d47a1?style=for-the-badge&logo=git&logoColor=white" />
  <img src="https://img.shields.io/badge/Postman-1565C0?style=for-the-badge&logo=postman&logoColor=white" />
  <img src="https://img.shields.io/badge/VS%20Code-1a237e?style=for-the-badge&logo=visual-studio-code&logoColor=white" />
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/PyTorch-1a237e?style=for-the-badge&logo=pytorch&logoColor=white" />
  <img src="https://img.shields.io/badge/CNN--LSTM-0d47a1?style=for-the-badge&logo=pytorch&logoColor=white" />
...
<table>
  <tr>
    ...
    <td width="75%" valign="top">
      ...
      Developing a comprehensive stock market education and virtual trading platform using ASP.NET Core & React.
      <ul>
        <li>Architected RESTful APIs for 5+ core modules: course management, virtual trading, portfolio tracking, AI-driven investment analysis</li>
        <li>Reduced API response time by ~40% via Redis caching & EF Core query optimization</li>
        <li>Implemented RBAC with JWT/OAuth2 supporting 3 user roles with granular permissions</li>
        <li>Designed SQL Server schema with 10+ entities, stored procedures for complex reporting</li>
        <li>Improved frontend performance via React code-splitting & lazy-loading</li>
      </ul>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>💳 Payment Order Management (ProjectN)</h3>
      <p><sub>React · Node.js · Express · MongoDB · Socket.io</sub></p>
      <ul>
        <li>Real-time order notifications via Socket.io</li>
        <li>RBAC with 3 roles & 10+ distinct actions</li>
        <li>Reduced receipt load time by 60% via aggregation pipelines</li>
        <li>Printable A5 Arabic RTL financial reports</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>📈 Online Trade Platform (StockSquares)</h3>
      <p><sub>ASP.NET Core · Onion Architecture · SQL Server · JWT</sub></p>
      <ul>
        <li>Clean Onion Architecture for long-term scalability</li>
        <li>JWT-based auth, virtual trading engine, portfolios</li>
        <li>Market trend tracking & trade history</li>
        <li>Optimized SQL Server queries & stored procedures</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><sub>ASP.NET Core · Third-party API Integration</sub></p>
      <ul>
        <li>Patient scheduling & doctor availability management</li>
        <li>Automated appointment reminder notifications</li>
        <li>Clean RESTful API design</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🤟 Arabic Sign Language Recognition (ArSLR)</h3>
      <p><sub>Python · Django · MediaPipe · CNN-LSTM</sub></p>
      <ul>
        <li>Real-time ArSL translation web application</li>
        <li>MediaPipe hand landmark detection</li>
        <li>CNN-LSTM hybrid model for dynamic sign classification</li>
        <li>Published at NILES 2024 International Conference</li>
      </ul>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td width="35%"><b>🚀 DEPI – .NET Developer Bootcamp</b><br/><sub>Government-sponsored intensive program</sub><br/><sub>ASP.NET Core · REST APIs · SQL Server · 05/2024 – 09/2024</sub></td>
